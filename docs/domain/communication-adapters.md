...
- physical transport: `serial`, `gpib`, `ethernet_tcp`, `ethernet_udp`, `can`,
  `usb`, `none`;
- access provider: `native_serial`, `native_tcp`, `native_udp`, `visa`,
  `socketcan`, `pcan`, `vector_can`, `usbtmc`, `hid`, `custom_adapter`,
  `simulation`;
- application protocol: `scpi`, `raw_ascii`, `raw_binary`, `can_frames`,
...
port. VISA, vendor CAN, USBTMC and HID are modeled and simulated but reported
