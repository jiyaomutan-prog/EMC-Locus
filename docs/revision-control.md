...
Version `0.22.2` was validated on 2026-08-05 with the CI-equivalent command
...
For `0.22.2`, Playwright proves the method hierarchy, explicit v1 successor,
typed method content, reusable conducted/radiated/emissions topology, closed
feedback, sub-range preview, execution-plan compilation, dated preparation,
physical resolution, category aliases, targeted failure isolation, restart
persistence and keyboard/responsive operation. It also preserves the complete
0.22.1 station and preparation acceptance path.
The reviewed 0.22.2 states are captured at
