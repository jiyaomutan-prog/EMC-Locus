...
CREATE TABLE sync_entity_snapshots_v4 (
...
INSERT INTO sync_entity_snapshots_v4
SELECT * FROM sync_entity_snapshots;

DROP TABLE sync_entity_snapshots;
ALTER TABLE sync_entity_snapshots_v4 RENAME TO sync_entity_snapshots;

CREATE INDEX idx_sync_entity_snapshots_entity
ON sync_entity_snapshots(domain, entity_type, entity_id, captured_at);

CREATE TABLE sync_checkpoints_v4 (
...
INSERT INTO sync_checkpoints_v4
SELECT * FROM sync_checkpoints;

DROP TABLE sync_checkpoints;
ALTER TABLE sync_checkpoints_v4 RENAME TO sync_checkpoints;
...
VALUES
    ('equipment_domain_supported', 'true', '2026-07-03T00:00:00Z');

INSERT INTO schema_migrations(version, name, applied_at)
VALUES (4, 'equipment_domain', '2026-07-03T00:00:00Z');
