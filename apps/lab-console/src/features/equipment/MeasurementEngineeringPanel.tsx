...
const configs: Record<MeasurementSpace, MeasurementStudioConfig> = {
  sensors: {
    ...
    sections: [
      ...
      ["scaling", "Conversion du signal brut"],
      ["corrections", "Correction selon la fréquence"],
      ["revisions", "Révisions"],
      ["audit", "Audit"],
  ...
  scaling: {
    ...
    title: "Conversions du signal brut",
    listTitle: "Conversions du signal brut",
  ...
  curves: {
    ...
    title: "Corrections selon la fréquence",
    listTitle: "Corrections amplitude / phase",
    createLabel: "Nouvelle correction",
